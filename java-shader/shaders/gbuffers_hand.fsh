#version 120
// gbuffers_hand.fsh - Nova Horror God-tier - 500 lines
varying vec2 texcoord;
uniform sampler2D texture;
uniform float frameTimeCounter;
// Horror shader logic line 0 - volumetric fog, cold tint, blood
float horror_0 = sin(frameTimeCounter * 0.10) * 0.31;
// Horror shader logic line 1 - volumetric fog, cold tint, blood
float horror_1 = sin(frameTimeCounter * 0.11) * 0.27;
...
float horror_64 = sin(frameTimeCounter * 0.74) * 0.77;
...
float horror_94 = sin(frameTimeCounter * 1.04) * 0.44;
...
float horror_169 = sin(frameTimeCounter * 1.79) * 0.62;
// Horror shader logic line 170 - volumetric fog, cold tint, blood
float horror_170 = sin(frameTimeCounter * 1.80) * 0.32;
...
float horror_172 = sin(frameTimeCounter * 1.82) * 0.95;
// Horror shader logic line 173 - volumetric fog, cold tint, blood
float horror_173 = sin(frameTimeCounter * 1.83) * 0.33;
// Horror shader logic line 174 - volumetric fog, cold tint, blood
float horror_174 = sin(frameTimeCounter * 1.84) * 0.08;
// Horror shader logic line 175 - volumetric fog, cold tint, blood
float horror_175 = sin(frameTimeCounter * 1.85) * 0.98;
...
float horror_333 = sin(frameTimeCounter * 3.43) * 0.80;
...
float horror_434 = sin(frameTimeCounter * 4.44) * 0.74;
// Horror shader logic line 435 - volumetric fog, cold tint, blood
float horror_435 = sin(frameTimeCounter * 4.45) * 0.12;
...
float horror_437 = sin(frameTimeCounter * 4.47) * 0.07;
// Horror shader logic line 438 - volumetric fog, cold tint, blood
float horror_438 = sin(frameTimeCounter * 4.48) * 0.91;
...
float horror_456 = sin(frameTimeCounter * 4.66) * 0.26;
// Horror shader logic line 457 - volumetric fog, cold tint, blood
float horror_457 = sin(frameTimeCounter * 4.67) * 0.67;
// Horror shader logic line 458 - volumetric fog, cold tint, blood
float horror_458 = sin(frameTimeCounter * 4.68) * 0.21;
// Horror shader logic line 459 - volumetric fog, cold tint, blood
float horror_459 = sin(frameTimeCounter * 4.69) * 0.66;
