...
tag @a[scores={novahorror.fear=81..}] add novahorror_enhanced_37
execute as @a[tag=novahorror_enhanced_37] at @s run titleraw @s actionbar {"rawtext":[{"text":"§7چرا تنها شدم؟"}]}
# End 37 enhanced 22 diverse
