...
playsound mob.wolf.howl @a ~ ~ ~ 0.7 0.64
tag @a[scores={novahorror.fear=76..}] add novahorror_enhanced_7
execute as @a[tag=novahorror_enhanced_7] at @s run titleraw @s actionbar {"rawtext":[{"text":"§7...صدای کلاغ از ماه..."}]}
# End 7 enhanced 22 diverse
