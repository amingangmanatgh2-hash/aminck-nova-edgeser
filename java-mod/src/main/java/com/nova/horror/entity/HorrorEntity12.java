...
/**
 * HorrorEntity12 - Real horror entity 12
...
public class HorrorEntity12 extends Monster {
    ...
    public static AttributeSupplier.Builder createAttributes() { return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 80.0).add(Attributes.MOVEMENT_SPEED, 0.37).add(Attributes.ATTACK_DAMAGE, 8.0).add(Attributes.FOLLOW_RANGE, 37.0); }
    ...
    public void teleportBehind1_12(Player player) {
    ...
    public void playNightSounds7_12() {
    ...
    public void ambushInDark8_12(Player player) {
    ...
    public void chasePlayer11_12(Player player) {
        if (player == null || level.isClientSide) return;
