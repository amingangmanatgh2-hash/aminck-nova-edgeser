...
/**
 * HorrorEntity18 - Real horror entity 18
...
public class HorrorEntity18 extends Monster {
    ...
    public static AttributeSupplier.Builder createAttributes() { return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 110.0).add(Attributes.MOVEMENT_SPEED, 0.43).add(Attributes.ATTACK_DAMAGE, 6.0).add(Attributes.FOLLOW_RANGE, 43.0); }
    ...
    public void chasePlayer5_18(Player player) {
    ...
    public void dropJumpscare6_18(Player player) {
    ...
    public void ambushInDark7_18(Player player) {
    ...
    public void dropJumpscare10_18(Player player) {
        if (player == null || !isOnCeiling) return;
        if (distanceTo(player) < 5 && random.nextInt(30)==0) {
            isOnCeiling = false;
            setNoGravity(false);
    ...
    public void dropJumpscare12_18(Player player) {
        if (player == null || !isOnCeiling) return;
        if (distanceTo(player) < 5 && random.nextInt(30)==0) {
            isOnCeiling = false;
            setNoGravity(false);
    ...
    public void playNightSounds14_18() {
