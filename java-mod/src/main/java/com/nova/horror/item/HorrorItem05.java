...
/** HorrorItem05 - Unique item 5 */
public class HorrorItem05 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem05() { super(new Properties().stacksTo(1).rarity(Rarity.RARE)); }
    ...
    public void uniqueMethod0_5(Player player, Level level) {
        // Unique method 0 for item 5
    ...
    public void uniqueMethod1_5(Player player, Level level) {
        // Unique method 1 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_5(Player player, Level level) {
        // Unique method 2 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_5(Player player, Level level) {
        // Unique method 3 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_5(Player player, Level level) {
        // Unique method 4 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_5(Player player, Level level) {
        // Unique method 5 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_5(Player player, Level level) {
        // Unique method 6 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_5(Player player, Level level) {
        // Unique method 7 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_5(Player player, Level level) {
        // Unique method 8 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_5(Player player, Level level) {
        // Unique method 9 for item 5
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
