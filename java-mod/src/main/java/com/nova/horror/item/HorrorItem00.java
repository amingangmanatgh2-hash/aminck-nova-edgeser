...
/** HorrorItem00 - Unique item 0 */
public class HorrorItem00 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem00() { super(new Properties().stacksTo(1).rarity(Rarity.UNCOMMON)); }
    ...
    public void uniqueMethod0_0(Player player, Level level) {
        // Unique method 0 for item 0
    ...
    public void uniqueMethod1_0(Player player, Level level) {
        // Unique method 1 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_0(Player player, Level level) {
        // Unique method 2 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_0(Player player, Level level) {
        // Unique method 3 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_0(Player player, Level level) {
        // Unique method 4 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_0(Player player, Level level) {
        // Unique method 5 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_0(Player player, Level level) {
        // Unique method 6 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_0(Player player, Level level) {
        // Unique method 7 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_0(Player player, Level level) {
        // Unique method 8 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_0(Player player, Level level) {
        // Unique method 9 for item 0
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
