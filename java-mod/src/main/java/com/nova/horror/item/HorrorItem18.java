...
/** HorrorItem18 - Unique item 18 */
public class HorrorItem18 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem18() { super(new Properties().stacksTo(1).rarity(Rarity.EPIC)); }
    ...
    public void uniqueMethod0_18(Player player, Level level) {
        // Unique method 0 for item 18
    ...
    public void uniqueMethod1_18(Player player, Level level) {
        // Unique method 1 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_18(Player player, Level level) {
        // Unique method 2 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_18(Player player, Level level) {
        // Unique method 3 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_18(Player player, Level level) {
        // Unique method 4 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_18(Player player, Level level) {
        // Unique method 5 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_18(Player player, Level level) {
        // Unique method 6 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_18(Player player, Level level) {
        // Unique method 7 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_18(Player player, Level level) {
        // Unique method 8 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_18(Player player, Level level) {
        // Unique method 9 for item 18
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
