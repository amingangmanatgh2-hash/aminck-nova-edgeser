...
/** HorrorItem07 - Unique item 7 */
public class HorrorItem07 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem07() { super(new Properties().stacksTo(1).rarity(Rarity.UNCOMMON)); }
    ...
    public void uniqueMethod0_7(Player player, Level level) {
        // Unique method 0 for item 7
    ...
    public void uniqueMethod1_7(Player player, Level level) {
        // Unique method 1 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_7(Player player, Level level) {
        // Unique method 2 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_7(Player player, Level level) {
        // Unique method 3 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_7(Player player, Level level) {
        // Unique method 4 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_7(Player player, Level level) {
        // Unique method 5 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_7(Player player, Level level) {
        // Unique method 6 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_7(Player player, Level level) {
        // Unique method 7 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_7(Player player, Level level) {
        // Unique method 8 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_7(Player player, Level level) {
        // Unique method 9 for item 7
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
