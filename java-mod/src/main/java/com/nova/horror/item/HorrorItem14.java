...
/** HorrorItem14 - Unique item 14 */
public class HorrorItem14 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem14() { super(new Properties().stacksTo(1).rarity(Rarity.RARE)); }
    ...
    public void uniqueMethod0_14(Player player, Level level) {
        // Unique method 0 for item 14
    ...
    public void uniqueMethod1_14(Player player, Level level) {
        // Unique method 1 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_14(Player player, Level level) {
        // Unique method 2 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_14(Player player, Level level) {
        // Unique method 3 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_14(Player player, Level level) {
        // Unique method 4 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_14(Player player, Level level) {
        // Unique method 5 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_14(Player player, Level level) {
        // Unique method 6 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_14(Player player, Level level) {
        // Unique method 7 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_14(Player player, Level level) {
        // Unique method 8 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_14(Player player, Level level) {
        // Unique method 9 for item 14
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
