...
/** HorrorItem08 - Unique item 8 */
public class HorrorItem08 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem08() { super(new Properties().stacksTo(1).rarity(Rarity.RARE)); }
    ...
    public void uniqueMethod0_8(Player player, Level level) {
        // Unique method 0 for item 8
    ...
    public void uniqueMethod1_8(Player player, Level level) {
        // Unique method 1 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_8(Player player, Level level) {
        // Unique method 2 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_8(Player player, Level level) {
        // Unique method 3 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_8(Player player, Level level) {
        // Unique method 4 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_8(Player player, Level level) {
        // Unique method 5 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_8(Player player, Level level) {
        // Unique method 6 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_8(Player player, Level level) {
        // Unique method 7 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_8(Player player, Level level) {
        // Unique method 8 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_8(Player player, Level level) {
        // Unique method 9 for item 8
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
