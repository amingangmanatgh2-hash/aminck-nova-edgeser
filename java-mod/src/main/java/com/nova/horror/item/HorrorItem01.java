...
/** HorrorItem01 - Unique item 1 */
public class HorrorItem01 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem01() { super(new Properties().stacksTo(1).rarity(Rarity.RARE)); }
    ...
    public void uniqueMethod0_1(Player player, Level level) {
        // Unique method 0 for item 1
    ...
    public void uniqueMethod1_1(Player player, Level level) {
        // Unique method 1 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_1(Player player, Level level) {
        // Unique method 2 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_1(Player player, Level level) {
        // Unique method 3 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_1(Player player, Level level) {
        // Unique method 4 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_1(Player player, Level level) {
        // Unique method 5 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_1(Player player, Level level) {
        // Unique method 6 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_1(Player player, Level level) {
        // Unique method 7 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_1(Player player, Level level) {
        // Unique method 8 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_1(Player player, Level level) {
        // Unique method 9 for item 1
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
