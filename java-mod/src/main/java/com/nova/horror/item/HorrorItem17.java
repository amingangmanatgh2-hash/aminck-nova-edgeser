...
/** HorrorItem17 - Unique item 17 */
public class HorrorItem17 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem17() { super(new Properties().stacksTo(1).rarity(Rarity.EPIC)); }
    ...
    public void uniqueMethod0_17(Player player, Level level) {
        // Unique method 0 for item 17
    ...
    public void uniqueMethod1_17(Player player, Level level) {
        // Unique method 1 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_17(Player player, Level level) {
        // Unique method 2 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_17(Player player, Level level) {
        // Unique method 3 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_17(Player player, Level level) {
        // Unique method 4 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_17(Player player, Level level) {
        // Unique method 5 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_17(Player player, Level level) {
        // Unique method 6 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_17(Player player, Level level) {
        // Unique method 7 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_17(Player player, Level level) {
        // Unique method 8 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_17(Player player, Level level) {
        // Unique method 9 for item 17
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
