...
/** HorrorItem03 - Unique item 3 */
public class HorrorItem03 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem03() { super(new Properties().stacksTo(1).rarity(Rarity.EPIC)); }
    ...
    public void uniqueMethod0_3(Player player, Level level) {
        // Unique method 0 for item 3
    ...
    public void uniqueMethod1_3(Player player, Level level) {
        // Unique method 1 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_3(Player player, Level level) {
        // Unique method 2 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_3(Player player, Level level) {
        // Unique method 3 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_3(Player player, Level level) {
        // Unique method 4 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_3(Player player, Level level) {
        // Unique method 5 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_3(Player player, Level level) {
        // Unique method 6 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_3(Player player, Level level) {
        // Unique method 7 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_3(Player player, Level level) {
        // Unique method 8 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_3(Player player, Level level) {
        // Unique method 9 for item 3
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
