...
/** HorrorItem02 - Unique item 2 */
public class HorrorItem02 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem02() { super(new Properties().stacksTo(1).rarity(Rarity.EPIC)); }
    ...
    public void uniqueMethod0_2(Player player, Level level) {
        // Unique method 0 for item 2
    ...
    public void uniqueMethod1_2(Player player, Level level) {
        // Unique method 1 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_2(Player player, Level level) {
        // Unique method 2 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_2(Player player, Level level) {
        // Unique method 3 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_2(Player player, Level level) {
        // Unique method 4 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_2(Player player, Level level) {
        // Unique method 5 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_2(Player player, Level level) {
        // Unique method 6 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_2(Player player, Level level) {
        // Unique method 7 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_2(Player player, Level level) {
        // Unique method 8 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_2(Player player, Level level) {
        // Unique method 9 for item 2
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
