...
/** HorrorItem04 - Unique item 4 */
public class HorrorItem04 extends Item {
    private static final Random RANDOM = new Random();
    public HorrorItem04() { super(new Properties().stacksTo(1).rarity(Rarity.RARE)); }
    ...
    public void uniqueMethod0_4(Player player, Level level) {
        // Unique method 0 for item 4
    ...
    public void uniqueMethod1_4(Player player, Level level) {
        // Unique method 1 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod2_4(Player player, Level level) {
        // Unique method 2 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod3_4(Player player, Level level) {
        // Unique method 3 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod4_4(Player player, Level level) {
        // Unique method 4 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod5_4(Player player, Level level) {
        // Unique method 5 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod6_4(Player player, Level level) {
        // Unique method 6 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod7_4(Player player, Level level) {
        // Unique method 7 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod8_4(Player player, Level level) {
        // Unique method 8 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
    ...
    public void uniqueMethod9_4(Player player, Level level) {
        // Unique method 9 for item 4
        if (level.isClientSide) return;
        BlockPos pos = player.blockPosition();
