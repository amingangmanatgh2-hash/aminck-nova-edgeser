...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:ambient.basalt_deltas.mood hostile @s ~ ~ ~ 0.6 0.52
summon minecraft:parrot ~5 ~9 ~8 {CustomName:'"§8Raven 146-21"',NoGravity:0b,Tags:["raven_146"]}
title @a[scores={novahorror.fear=78..}] actionbar {"text":"§c...برگرد...","color":"dark_red"}
# End horror 146 enhanced 25 diverse
