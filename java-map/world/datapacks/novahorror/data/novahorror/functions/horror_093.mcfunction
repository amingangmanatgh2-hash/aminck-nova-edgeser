...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.wolf.howl hostile @s ~ ~ ~ 0.6 0.92
summon minecraft:parrot ~9 ~15 ~-3 {CustomName:'"§8Raven 93-21"',NoGravity:0b,Tags:["raven_93"]}
title @a[scores={novahorror.fear=58..}] actionbar {"text":"§7صدای پا...","color":"dark_red"}
# End horror 093 enhanced 25 diverse
