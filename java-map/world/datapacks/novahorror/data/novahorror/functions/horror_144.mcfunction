# Horror function 144 - Ravenshollow
...
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 3
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 1.30
...
particle minecraft:ash ~ ~1 ~ 0.6 0.0 0.7 0.1 10
particle minecraft:ash ~ ~1 ~ 0.7 0.1 0.6 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 1
...
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-31","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-32","color":"gray","italic":true}
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 1.39
particle minecraft:ash ~ ~1 ~ 0.2 0.9 0.8 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-35","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.8 0.2 0.4 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 0.62
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.6 0.9 0.8 0.1 10
particle minecraft:ash ~ ~1 ~ 0.3 0.4 0.5 0.1 10
scoreboard players add @a novahorror.fear 1
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 1.01
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-47","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 4 1 true
effect give @a[distance=..10] minecraft:darkness 3 0 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-50","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-52","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 0.2 0.9 0.9 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-58","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 2 0 true
particle minecraft:ash ~ ~1 ~ 0.7 0.5 0.1 0.1 10
title @a[scores={novahorror.fear=56..}] title {"text":"او اینجاست!","color":"dark_red"}
title @a[scores={novahorror.fear=27..}] title {"text":"او اینجاست!","color":"dark_red"}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-63","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-64","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.7 0.5 0.6 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-66","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
...
scoreboard players add @a novahorror.fear 3
particle minecraft:ash ~ ~1 ~ 0.4 0.5 0.1 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-79","color":"gray","italic":true}
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 1.14
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-81","color":"gray","italic":true}
...
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.3 1.0 0.1 0.1 10
particle minecraft:ash ~ ~1 ~ 0.9 0.1 0.4 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.2 0.9 0.4 0.1 10
effect give @a[distance=..10] minecraft:darkness 2 2 true
playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 1 0.92
...
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-109","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.9 0.6 0.3 0.1 10
particle minecraft:ash ~ ~1 ~ 0.4 0.0 0.1 0.1 10
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-113","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 2 0 true
effect give @a[distance=..10] minecraft:darkness 4 2 true
...
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 0.51
scoreboard players add @a novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-124","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-126","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 1
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-133","color":"gray","italic":true}
title @a[scores={novahorror.fear=68..}] title {"text":"او اینجاست!","color":"dark_red"}
effect give @a[distance=..10] minecraft:darkness 2 2 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-136","color":"gray","italic":true}
title @a[scores={novahorror.fear=27..}] title {"text":"او اینجاست!","color":"dark_red"}
effect give @a[distance=..10] minecraft:darkness 4 2 true
scoreboard players add @a novahorror.fear 3
effect give @a[distance=..10] minecraft:darkness 3 1 true
playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 1 0.66
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 144-142","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
