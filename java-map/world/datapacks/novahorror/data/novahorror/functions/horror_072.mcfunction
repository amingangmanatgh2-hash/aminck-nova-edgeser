...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.ghast.scream hostile @s ~ ~ ~ 0.6 0.82
summon minecraft:parrot ~7 ~11 ~3 {CustomName:'"§8Raven 72-21"',NoGravity:0b,Tags:["raven_72"]}
title @a[scores={novahorror.fear=61..}] actionbar {"text":"§5...زمان برگشت...","color":"dark_red"}
# End horror 072 enhanced 25 diverse
