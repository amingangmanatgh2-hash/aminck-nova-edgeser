...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.ghast.scream hostile @s ~ ~ ~ 0.6 0.60
summon minecraft:parrot ~7 ~14 ~10 {CustomName:'"§8Raven 35-21"',NoGravity:0b,Tags:["raven_35"]}
title @a[scores={novahorror.fear=85..}] actionbar {"text":"§7مه غلیظ...","color":"dark_red"}
# End horror 035 enhanced 25 diverse
