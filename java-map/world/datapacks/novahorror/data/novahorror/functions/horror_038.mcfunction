...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:block.portal.ambient hostile @s ~ ~ ~ 0.6 0.46
summon minecraft:parrot ~-7 ~15 ~4 {CustomName:'"§8Raven 38-21"',NoGravity:0b,Tags:["raven_38"]}
title @a[scores={novahorror.fear=62..}] actionbar {"text":"§7...نمی‌تونی فرار کنی...","color":"dark_red"}
# End horror 038 enhanced 25 diverse
