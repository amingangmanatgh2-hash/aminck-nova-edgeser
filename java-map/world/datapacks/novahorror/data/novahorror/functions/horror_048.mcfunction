...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:block.sculk_sensor.clicking hostile @s ~ ~ ~ 0.6 0.71
summon minecraft:parrot ~13 ~7 ~-5 {CustomName:'"§8Raven 48-21"',NoGravity:0b,Tags:["raven_48"]}
title @a[scores={novahorror.fear=60..}] actionbar {"text":"§cنمی‌تونم نفس بکشم...","color":"dark_red"}
# End horror 048 enhanced 25 diverse
