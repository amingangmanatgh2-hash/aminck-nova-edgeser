...
summon minecraft:parrot ~5 ~9 ~-4 {CustomName:'"§8Raven 118-21"',NoGravity:0b,Tags:["raven_118"]}
title @a[scores={novahorror.fear=74..}] actionbar {"text":"§cکمک...","color":"dark_red"}
# End horror 118 enhanced 25 diverse
