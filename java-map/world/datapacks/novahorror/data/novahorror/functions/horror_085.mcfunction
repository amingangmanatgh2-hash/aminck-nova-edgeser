...
summon minecraft:parrot ~-2 ~7 ~-1 {CustomName:'"§8Raven 85-21"',NoGravity:0b,Tags:["raven_85"]}
title @a[scores={novahorror.fear=59..}] actionbar {"text":"§7مه غلیظ...","color":"dark_red"}
# End horror 085 enhanced 25 diverse
