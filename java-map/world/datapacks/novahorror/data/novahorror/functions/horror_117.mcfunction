# Horror function 117 - Ravenshollow
# Coordinated with mod and command blocks
particle minecraft:ash ~ ~1 ~ 1.0 0.5 0.1 0.1 10
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-5","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 0.2 0.4 0.2 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
effect give @a[distance=..10] minecraft:darkness 2 0 true
effect give @a[distance=..10] minecraft:darkness 5 2 true
scoreboard players add @a novahorror.fear 3
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-14","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 1
effect give @a[distance=..10] minecraft:darkness 2 0 true
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 0.72
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-19","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 5 0 true
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 0.90
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-22","color":"gray","italic":true}
title @a[scores={novahorror.fear=46..}] title {"text":"او اینجاست!","color":"dark_red"}
scoreboard players add @a novahorror.fear 2
scoreboard players add @a novahorror.fear 1
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 1.25
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-27","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
effect give @a[distance=..10] minecraft:darkness 3 1 true
scoreboard players add @a novahorror.fear 2
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-33","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.2 0.6 0.5 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-36","color":"gray","italic":true}
...
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-46","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.0 0.5 0.4 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-48","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.3 0.2 0.9 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 0.58
scoreboard players add @a novahorror.fear 3
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 1.50
particle minecraft:ash ~ ~1 ~ 0.1 0.3 0.7 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.3 0.1 0.2 0.1 10
effect give @a[distance=..10] minecraft:darkness 5 1 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-59","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 5 0 true
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-63","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 0.3 0.3 0.3 0.1 10
title @a[scores={novahorror.fear=90..}] title {"text":"او اینجاست!","color":"dark_red"}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-74","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.6 0.2 0.7 0.1 10
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-87","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 5 1 true
...
scoreboard players add @a novahorror.fear 3
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-101","color":"gray","italic":true}
title @a[scores={novahorror.fear=95..}] title {"text":"او اینجاست!","color":"dark_red"}
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 1.31
particle minecraft:ash ~ ~1 ~ 0.1 0.6 0.2 0.1 10
scoreboard players add @a novahorror.fear 2
title @a[scores={novahorror.fear=62..}] title {"text":"او اینجاست!","color":"dark_red"}
particle minecraft:ash ~ ~1 ~ 0.2 0.9 1.0 0.1 10
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 1.11
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-118","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-119","color":"gray","italic":true}
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 0.50
particle minecraft:ash ~ ~1 ~ 0.5 0.8 0.6 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-123","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
particle minecraft:ash ~ ~1 ~ 0.1 0.8 1.0 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-131","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-132","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
effect give @a[distance=..10] minecraft:darkness 2 0 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-135","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 1
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 1.07
scoreboard players add @a novahorror.fear 2
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 0.46
scoreboard players add @a novahorror.fear 3
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-143","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.9 0.0 0.5 0.1 10
effect give @a[distance=..10] minecraft:darkness 1 0 true
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 117-148","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 1
