...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.warden.roar hostile @s ~ ~ ~ 0.6 0.88
summon minecraft:parrot ~13 ~5 ~-15 {CustomName:'"§8Raven 81-21"',NoGravity:0b,Tags:["raven_81"]}
title @a[scores={novahorror.fear=69..}] actionbar {"text":"§cکمک...","color":"dark_red"}
# End horror 081 enhanced 25 diverse
