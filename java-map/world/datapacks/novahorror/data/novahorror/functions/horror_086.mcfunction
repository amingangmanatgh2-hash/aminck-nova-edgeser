...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:ambient.cave hostile @s ~ ~ ~ 0.6 0.73
summon minecraft:parrot ~3 ~14 ~-12 {CustomName:'"§8Raven 86-21"',NoGravity:0b,Tags:["raven_86"]}
title @a[scores={novahorror.fear=59..}] actionbar {"text":"§5...زمان برگشت...","color":"dark_red"}
# End horror 086 enhanced 25 diverse
