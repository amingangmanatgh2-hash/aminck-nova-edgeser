...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.soul_sand_valley_mood hostile @s ~ ~ ~ 0.6 0.72
summon minecraft:parrot ~6 ~7 ~-14 {CustomName:'"§8Raven 64-21"',NoGravity:0b,Tags:["raven_64"]}
title @a[scores={novahorror.fear=85..}] actionbar {"text":"§8سایه...","color":"dark_red"}
# End horror 064 enhanced 25 diverse
