...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.parrot.imitate.ghast hostile @s ~ ~ ~ 0.6 0.70
summon minecraft:parrot ~-6 ~13 ~4 {CustomName:'"§8Raven 28-21"',NoGravity:0b,Tags:["raven_28"]}
title @a[scores={novahorror.fear=69..}] actionbar {"text":"§c...برگرد...","color":"dark_red"}
# End horror 028 enhanced 25 diverse
