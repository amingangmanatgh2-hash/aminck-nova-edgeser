...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.zombie.ambient hostile @s ~ ~ ~ 0.6 0.79
summon minecraft:parrot ~6 ~8 ~15 {CustomName:'"§8Raven 67-21"',NoGravity:0b,Tags:["raven_67"]}
title @a[scores={novahorror.fear=61..}] actionbar {"text":"§7...نمی‌تونی فرار کنی...","color":"dark_red"}
# End horror 067 enhanced 25 diverse
