# Horror function 88 - Ravenshollow
# Coordinated with mod and command blocks
particle minecraft:ash ~ ~1 ~ 0.7 0.2 0.4 0.1 10
...
particle minecraft:ash ~ ~1 ~ 0.1 0.8 0.8 0.1 10
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-21","color":"gray","italic":true}
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-27","color":"gray","italic":true}
title @a[scores={novahorror.fear=87..}] title {"text":"او اینجاست!","color":"dark_red"}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-30","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
title @a[scores={novahorror.fear=92..}] title {"text":"او اینجاست!","color":"dark_red"}
particle minecraft:ash ~ ~1 ~ 0.4 0.9 0.3 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-35","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 1.0 0.4 0.5 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.4 0.3 0.1 0.1 10
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-55","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-62","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-63","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.9 0.6 0.7 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-65","color":"gray","italic":true}
...
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.3 0.4 0.4 0.1 10
...
particle minecraft:ash ~ ~1 ~ 0.2 0.6 0.2 0.1 10
scoreboard players add @a novahorror.fear 3
scoreboard players add @a novahorror.fear 3
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 3
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-106","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 5 0 true
...
particle minecraft:ash ~ ~1 ~ 0.7 0.8 0.1 0.1 10
particle minecraft:ash ~ ~1 ~ 0.8 1.0 0.2 0.1 10
...
scoreboard players add @a novahorror.fear 3
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 1.37
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-124","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 2 0 true
particle minecraft:ash ~ ~1 ~ 0.5 0.1 0.6 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.5 0.2 0.6 0.1 10
particle minecraft:ash ~ ~1 ~ 0.4 0.4 0.8 0.1 10
particle minecraft:ash ~ ~1 ~ 0.9 0.0 0.4 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-131","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 2
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-142","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 3 0 true
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-146","color":"gray","italic":true}
title @a[scores={novahorror.fear=60..}] title {"text":"او اینجاست!","color":"dark_red"}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 88-148","color":"gray","italic":true}
