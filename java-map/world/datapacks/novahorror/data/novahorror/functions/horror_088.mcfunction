...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:block.portal.ambient hostile @s ~ ~ ~ 0.6 0.61
summon minecraft:parrot ~-2 ~13 ~14 {CustomName:'"§8Raven 88-21"',NoGravity:0b,Tags:["raven_88"]}
title @a[scores={novahorror.fear=56..}] actionbar {"text":"§4خون...","color":"dark_red"}
# End horror 088 enhanced 25 diverse
