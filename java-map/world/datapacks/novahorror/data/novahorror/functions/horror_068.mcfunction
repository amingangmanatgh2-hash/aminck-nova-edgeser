...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.skeleton.ambient hostile @s ~ ~ ~ 0.6 0.67
summon minecraft:parrot ~7 ~10 ~2 {CustomName:'"§8Raven 68-21"',NoGravity:0b,Tags:["raven_68"]}
title @a[scores={novahorror.fear=54..}] actionbar {"text":"§c...برگرد...","color":"dark_red"}
# End horror 068 enhanced 25 diverse
