...
summon minecraft:parrot ~-5 ~6 ~3 {CustomName:'"§8Raven 142-21"',NoGravity:0b,Tags:["raven_142"]}
title @a[scores={novahorror.fear=51..}] actionbar {"text":"§4او می‌بینه...","color":"dark_red"}
# End horror 142 enhanced 25 diverse
