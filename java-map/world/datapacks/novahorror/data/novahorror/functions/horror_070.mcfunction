...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:ambient.basalt_deltas.mood hostile @s ~ ~ ~ 0.6 0.95
summon minecraft:parrot ~13 ~11 ~1 {CustomName:'"§8Raven 70-21"',NoGravity:0b,Tags:["raven_70"]}
title @a[scores={novahorror.fear=71..}] actionbar {"text":"§8سایه...","color":"dark_red"}
# End horror 070 enhanced 25 diverse
