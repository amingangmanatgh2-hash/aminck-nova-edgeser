...
summon minecraft:parrot ~-12 ~14 ~3 {CustomName:'"§8Raven 99-21"',NoGravity:0b,Tags:["raven_99"]}
title @a[scores={novahorror.fear=65..}] actionbar {"text":"§7مه غلیظ...","color":"dark_red"}
# End horror 099 enhanced 25 diverse
