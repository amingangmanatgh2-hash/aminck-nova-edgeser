...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.warden.sonic_boom hostile @s ~ ~ ~ 0.6 0.69
summon minecraft:parrot ~13 ~15 ~-5 {CustomName:'"§8Raven 0-21"',NoGravity:0b,Tags:["raven_0"]}
title @a[scores={novahorror.fear=62..}] actionbar {"text":"§c...برگرد...","color":"dark_red"}
# End horror 000 enhanced 25 diverse
