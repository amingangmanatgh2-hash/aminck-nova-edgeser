...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:ambient.cave hostile @s ~ ~ ~ 0.6 0.78
summon minecraft:parrot ~-8 ~15 ~-3 {CustomName:'"§8Raven 63-21"',NoGravity:0b,Tags:["raven_63"]}
title @a[scores={novahorror.fear=67..}] actionbar {"text":"§cنمی‌تونم نفس بکشم...","color":"dark_red"}
# End horror 063 enhanced 25 diverse
