...
summon minecraft:parrot ~-8 ~6 ~-14 {CustomName:'"§8Raven 32-21"',NoGravity:0b,Tags:["raven_32"]}
title @a[scores={novahorror.fear=50..}] actionbar {"text":"§cکمک...","color":"dark_red"}
# End horror 032 enhanced 25 diverse
