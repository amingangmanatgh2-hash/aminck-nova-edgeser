...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:block.portal.ambient hostile @s ~ ~ ~ 0.6 0.86
summon minecraft:parrot ~-15 ~9 ~-5 {CustomName:'"§8Raven 115-21"',NoGravity:0b,Tags:["raven_115"]}
title @a[scores={novahorror.fear=61..}] actionbar {"text":"§4او می‌بینه...","color":"dark_red"}
# End horror 115 enhanced 25 diverse
