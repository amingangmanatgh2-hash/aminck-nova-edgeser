# Horror function 191 - Ravenshollow
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-13","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
title @a[scores={novahorror.fear=75..}] title {"text":"او اینجاست!","color":"dark_red"}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-16","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 1.0 0.2 0.6 0.1 10
particle minecraft:ash ~ ~1 ~ 0.3 0.9 0.0 0.1 10
scoreboard players add @a novahorror.fear 1
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-22","color":"gray","italic":true}
...
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 2
particle minecraft:ash ~ ~1 ~ 0.2 0.5 0.8 0.1 10
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-40","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 0.1 0.5 0.4 0.1 10
scoreboard players add @a novahorror.fear 2
particle minecraft:ash ~ ~1 ~ 0.3 0.2 0.4 0.1 10
effect give @a[distance=..10] minecraft:darkness 5 1 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-53","color":"gray","italic":true}
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-71","color":"gray","italic":true}
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-74","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-84","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.5 0.5 0.7 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.4 0.7 0.8 0.1 10
effect give @a[distance=..10] minecraft:darkness 3 2 true
scoreboard players add @a novahorror.fear 3
scoreboard players add @a novahorror.fear 3
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
scoreboard players add @a novahorror.fear 3
particle minecraft:ash ~ ~1 ~ 0.4 0.2 0.8 0.1 10
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
...
particle minecraft:ash ~ ~1 ~ 0.8 0.3 0.6 0.1 10
...
scoreboard players add @a novahorror.fear 3
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 191-132","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 4 0 true
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
title @a[scores={novahorror.fear=26..}] title {"text":"او اینجاست!","color":"dark_red"}
effect give @a[distance=..10] minecraft:darkness 5 1 true
particle minecraft:ash ~ ~1 ~ 0.4 0.5 0.4 0.1 10
particle minecraft:ash ~ ~1 ~ 0.4 0.1 1.0 0.1 10
