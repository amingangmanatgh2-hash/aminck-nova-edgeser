...
summon minecraft:parrot ~-15 ~14 ~5 {CustomName:'"§8Raven 51-21"',NoGravity:0b,Tags:["raven_51"]}
title @a[scores={novahorror.fear=53..}] actionbar {"text":"§cکمک...","color":"dark_red"}
# End horror 051 enhanced 25 diverse
