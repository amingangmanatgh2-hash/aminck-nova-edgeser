...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.zombie.ambient hostile @s ~ ~ ~ 0.6 0.92
summon minecraft:parrot ~-2 ~7 ~-9 {CustomName:'"§8Raven 111-21"',NoGravity:0b,Tags:["raven_111"]}
title @a[scores={novahorror.fear=83..}] actionbar {"text":"§c...برگرد...","color":"dark_red"}
# End horror 111 enhanced 25 diverse
