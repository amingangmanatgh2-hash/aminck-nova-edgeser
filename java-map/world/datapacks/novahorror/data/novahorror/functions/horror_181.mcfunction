# Horror function 181 - Ravenshollow
# Coordinated with mod and command blocks
effect give @a[distance=..10] minecraft:darkness 5 2 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-1","color":"gray","italic":true}
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-6","color":"gray","italic":true}
...
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 3
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 0.81
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-24","color":"gray","italic":true}
...
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 0.49
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-30","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-31","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 1
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 1.21
scoreboard players add @a novahorror.fear 3
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-35","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
effect give @a[distance=..10] minecraft:darkness 3 0 true
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 1
scoreboard players add @a novahorror.fear 2
particle minecraft:ash ~ ~1 ~ 0.2 0.4 0.5 0.1 10
...
title @a[scores={novahorror.fear=77..}] title {"text":"او اینجاست!","color":"dark_red"}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 1.0 0.2 0.8 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-62","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-75","color":"gray","italic":true}
...
effect give @a[distance=..10] minecraft:darkness 3 1 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-84","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
title @a[scores={novahorror.fear=56..}] title {"text":"او اینجاست!","color":"dark_red"}
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-88","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-90","color":"gray","italic":true}
...
scoreboard players add @a novahorror.fear 2
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.4 0.9 1.0 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-102","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 3
effect give @a[distance=..10] minecraft:darkness 1 0 true
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-126","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 1.0 0.9 0.2 0.1 10
effect give @a[distance=..10] minecraft:darkness 2 1 true
particle minecraft:ash ~ ~1 ~ 0.9 0.9 0.5 0.1 10
effect give @a[distance=..10] minecraft:darkness 1 2 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 181-143","color":"gray","italic":true}
