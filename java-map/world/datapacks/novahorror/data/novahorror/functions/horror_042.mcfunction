...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.ender_man.stare hostile @s ~ ~ ~ 0.6 0.94
summon minecraft:parrot ~-4 ~5 ~-4 {CustomName:'"§8Raven 42-21"',NoGravity:0b,Tags:["raven_42"]}
title @a[scores={novahorror.fear=56..}] actionbar {"text":"§5...زمان برگشت...","color":"dark_red"}
# End horror 042 enhanced 25 diverse
