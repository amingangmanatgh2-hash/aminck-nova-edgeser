...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.skeleton.ambient hostile @s ~ ~ ~ 0.6 0.57
summon minecraft:parrot ~1 ~10 ~9 {CustomName:'"§8Raven 25-21"',NoGravity:0b,Tags:["raven_25"]}
title @a[scores={novahorror.fear=81..}] actionbar {"text":"§4او می‌بینه...","color":"dark_red"}
# End horror 025 enhanced 25 diverse
