# Horror function 163 - Ravenshollow
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-34","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 0.2 0.6 0.1 0.1 10
playsound minecraft:ambient.cave hostile @a ~ ~ ~ 1 1.13
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-42","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 2
...
scoreboard players add @a novahorror.fear 3
particle minecraft:ash ~ ~1 ~ 0.2 0.4 0.8 0.1 10
particle minecraft:ash ~ ~1 ~ 0.2 0.1 0.5 0.1 10
particle minecraft:ash ~ ~1 ~ 0.8 0.9 0.3 0.1 10
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 1.12
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 0.68
particle minecraft:ash ~ ~1 ~ 0.0 1.0 0.8 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 1.38
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 0.63
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-60","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-61","color":"gray","italic":true}
title @a[scores={novahorror.fear=27..}] title {"text":"او اینجاست!","color":"dark_red"}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-64","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-66","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 3
particle minecraft:ash ~ ~1 ~ 0.1 0.7 0.7 0.1 10
effect give @a[distance=..10] minecraft:darkness 4 2 true
...
scoreboard players add @a novahorror.fear 1
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-75","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.6 1.0 0.6 0.1 10
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 1.24
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-79","color":"gray","italic":true}
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 1.05
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-88","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-91","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 2
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-97","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.6 0.9 0.7 0.1 10
scoreboard players add @a novahorror.fear 2
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 1.36
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-103","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-104","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 2 1 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-106","color":"gray","italic":true}
...
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-115","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 3
title @a[scores={novahorror.fear=20..}] title {"text":"او اینجاست!","color":"dark_red"}
particle minecraft:ash ~ ~1 ~ 0.6 0.8 0.6 0.1 10
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-126","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
playsound minecraft:ambient.basalt_deltas.mood hostile @a ~ ~ ~ 1 0.60
particle minecraft:ash ~ ~1 ~ 0.1 0.8 0.1 0.1 10
...
particle minecraft:ash ~ ~1 ~ 0.4 0.9 0.0 0.1 10
effect give @a[distance=..10] minecraft:darkness 1 1 true
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-139","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 1 1.42
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-142","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-144","color":"gray","italic":true}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 163-145","color":"gray","italic":true}
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
title @a[scores={novahorror.fear=66..}] title {"text":"او اینجاست!","color":"dark_red"}
playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 1 0.36
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
