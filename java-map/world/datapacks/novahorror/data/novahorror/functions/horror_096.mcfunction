...
summon minecraft:parrot ~13 ~11 ~11 {CustomName:'"§8Raven 96-21"',NoGravity:0b,Tags:["raven_96"]}
title @a[scores={novahorror.fear=64..}] actionbar {"text":"§8در بسته است...","color":"dark_red"}
# End horror 096 enhanced 25 diverse
