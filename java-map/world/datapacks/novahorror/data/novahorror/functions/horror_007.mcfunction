...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:block.sculk_sensor.clicking hostile @s ~ ~ ~ 0.6 0.68
summon minecraft:parrot ~-5 ~12 ~13 {CustomName:'"§8Raven 7-21"',NoGravity:0b,Tags:["raven_7"]}
title @a[scores={novahorror.fear=52..}] actionbar {"text":"§c...برگرد...","color":"dark_red"}
# End horror 007 enhanced 25 diverse
