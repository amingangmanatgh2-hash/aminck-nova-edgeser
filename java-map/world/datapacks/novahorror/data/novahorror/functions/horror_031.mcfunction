...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:block.sculk_sensor.clicking hostile @s ~ ~ ~ 0.6 0.58
summon minecraft:parrot ~3 ~7 ~-5 {CustomName:'"§8Raven 31-21"',NoGravity:0b,Tags:["raven_31"]}
title @a[scores={novahorror.fear=81..}] actionbar {"text":"§8سایه...","color":"dark_red"}
# End horror 031 enhanced 25 diverse
