# Horror function 19 - Ravenshollow
...
playsound minecraft:entity.ghast.scream hostile @a ~ ~ ~ 1 0.94
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-9","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-13","color":"gray","italic":true}
...
particle minecraft:ash ~ ~1 ~ 0.6 0.2 0.0 0.1 10
...
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 0.81
effect give @a[distance=..10] minecraft:darkness 5 0 true
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 2
particle minecraft:ash ~ ~1 ~ 0.0 0.2 0.7 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-42","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-48","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 2
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-51","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 4 1 true
title @a[scores={novahorror.fear=48..}] title {"text":"او اینجاست!","color":"dark_red"}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-54","color":"gray","italic":true}
playsound minecraft:entity.warden.heartbeat hostile @a ~ ~ ~ 1 0.63
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
particle minecraft:ash ~ ~1 ~ 0.8 0.8 0.6 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-58","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 3
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
scoreboard players add @a novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-62","color":"gray","italic":true}
particle minecraft:ash ~ ~1 ~ 0.7 0.2 0.5 0.1 10
effect give @a[distance=..10] minecraft:darkness 5 1 true
...
scoreboard players add @a novahorror.fear 1
particle minecraft:ash ~ ~1 ~ 0.6 0.9 0.5 0.1 10
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-95","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 1
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
effect give @a[distance=..10] minecraft:darkness 5 2 true
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 0.94
particle minecraft:ash ~ ~1 ~ 0.4 0.8 0.1 0.1 10
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
effect give @a[distance=..10] minecraft:darkness 5 0 true
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-105","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-107","color":"gray","italic":true}
...
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-121","color":"gray","italic":true}
execute as @a at @s if block ~ ~-1 ~ minecraft:grass_block run scoreboard players add @s novahorror.fear 1
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-124","color":"gray","italic":true}
scoreboard players add @a novahorror.fear 3
scoreboard players add @a novahorror.fear 2
playsound minecraft:entity.parrot.imitate.ghast hostile @a ~ ~ ~ 1 0.53
scoreboard players add @a novahorror.fear 2
tellraw @a[distance=..20] {"text":"...صدای کلاغ از ماه... 19-129","color":"gray","italic":true}
effect give @a[distance=..10] minecraft:darkness 2 0 true
...
particle minecraft:ash ~ ~1 ~ 0.8 0.7 0.2 0.1 10
scoreboard players add @a novahorror.fear 2
...
execute at @a run summon minecraft:bat ~ ~5 ~ {CustomName:'"§8Crow"',NoGravity:1b}
scoreboard players add @a novahorror.fear 2
particle minecraft:ash ~ ~1 ~ 0.2 0.3 0.9 0.1 10
