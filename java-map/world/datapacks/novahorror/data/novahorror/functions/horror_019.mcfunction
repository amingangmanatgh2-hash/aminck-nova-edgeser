...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.warden.roar hostile @s ~ ~ ~ 0.6 0.73
summon minecraft:parrot ~-10 ~10 ~-15 {CustomName:'"§8Raven 19-21"',NoGravity:0b,Tags:["raven_19"]}
title @a[scores={novahorror.fear=63..}] actionbar {"text":"§7مه غلیظ...","color":"dark_red"}
# End horror 019 enhanced 25 diverse
