...
execute if predicate novahorror:is_night as @a at @s run playsound minecraft:entity.wolf.howl hostile @s ~ ~ ~ 0.6 0.87
summon minecraft:parrot ~0 ~11 ~6 {CustomName:'"§8Raven 61-21"',NoGravity:0b,Tags:["raven_61"]}
title @a[scores={novahorror.fear=56..}] actionbar {"text":"§8...الارا منتظره...","color":"dark_red"}
# End horror 061 enhanced 25 diverse
